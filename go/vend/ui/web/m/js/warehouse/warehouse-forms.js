    ...
    MobileWarehouseStock.forms = {
        ...
        VendStockMovement: f.form('Stock Movement', [
            f.section('Movement Details', [
                ...f.text('movementId', 'Movement ID', false, { readOnly: true }),
                ...f.text('warehouseId', 'Warehouse', false, { readOnly: true }),
                ...f.text('productId', 'Product', false, { readOnly: true }),
                ...f.text('movementType', 'Type', false, { readOnly: true }),
                ...f.text('quantity', 'Quantity', false, { readOnly: true }),
                ...f.text('timestamp', 'Timestamp', false, { readOnly: true })
            ])
        ]),
